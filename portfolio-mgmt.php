...
Contributors: We Are Pixel8, shazzner
Text Domain: portfolio-mgmt
Domain Path: /languages
License:
	Copyright 2012 - 2018 Heavy Heavy <hello@heavyheavy.com>
...
define( 'WAP8PORTFOLIO_VERSION', '2.0.2' );
 ...
 * @version 1.0.8
 * @since 2.0.2 removed link to settings page
...
add_action( 'admin_enqueue_scripts', 'wap8_portfolio_admin_styles' );
add_action( 'login_enqueue_scripts', 'wap8_portfolio_admin_styles' );
...
function wap8_portfolio_admin_styles() {
	wp_enqueue_style( 'wap8-portfolio-admin', plugin_dir_url( __FILE__ ) . 'css/wap8-portfolio-admin.css', '', WAP8PORTFOLIO_VERSION );
}